...
layout: default
nav_order: 4
description: "Recipe-driven guide organised by what you want to do: macOS / Linux workflows, golden images, cross-cutting features."
---

# Cookbook — recipes by goal
{: .no_toc }

A recipe-driven guide organised by *what you want to do*. For the per-command reference, see [`Usage.md`](https://github.com/everettjf/vm4a/blob/main/Usage.md).
{: .fs-5 .fw-300 }

{: .note }
> This page mirrors the repo's [`Cookbook.md`](https://github.com/everettjf/vm4a/blob/main/Cookbook.md) (Chinese: [`Cookbook.zh-CN.md`](https://github.com/everettjf/vm4a/blob/main/Cookbook.zh-CN.md)). If the two ever diverge, the root doc is canonical.
