...
parent: 中文文档
nav_order: 3
description: "按使用场景组织的实战手册：macOS / Linux 工作流、golden image、通用功能。"
---

# Cookbook —— 按场景的实战手册
{: .no_toc }

按"我想干什么"组织的实战手册。逐命令参考见 [`Usage.zh-CN.md`](https://github.com/everettjf/vm4a/blob/main/Usage.zh-CN.md)。
{: .fs-5 .fw-300 }

{: .note }
> 本页与仓库根目录的 [`Cookbook.zh-CN.md`](https://github.com/everettjf/vm4a/blob/main/Cookbook.zh-CN.md) 同源（英文版：[`Cookbook.md`](https://github.com/everettjf/vm4a/blob/main/Cookbook.md)）。若两处不一致，以仓库根目录版本为准。
