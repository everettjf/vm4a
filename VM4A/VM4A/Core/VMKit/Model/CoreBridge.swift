...
extension VMConfigModel {
    func toCore() -> VM4ACore.VMConfigModel {
        VM4ACore.VMConfigModel(
    ...
    static func fromCore(_ value: VM4ACore.VMConfigModel) -> Self {
        VMConfigModel(
...
extension VMStateModel {
    func toCore() -> VM4ACore.VMStateModel {
        .init(imagePath: imagePath)
    }

    static func fromCore(_ value: VM4ACore.VMStateModel) -> Self {
        .init(imagePath: value.imagePath)
    }
}

extension VMModel {
    func toCoreModel() -> VM4ACore.VMModel {
        .init(rootPath: rootPath, config: config.toCore(), state: state.toCore())
    }
}

extension VMOSType {
    func toCore() -> VM4ACore.VMOSType {
        switch self {
        case .macOS:
            return .macOS
        case .linux:
    ...
    static func fromCore(_ value: VM4ACore.VMOSType) -> VMOSType {
        switch value {
        case .macOS:
            return .macOS
        case .linux:
...
extension VMModelFieldGraphicDevice.DeviceType {
    func toCore() -> VM4ACore.VMModelFieldGraphicDevice.DeviceType {
        switch self {
        case .Mac:
            return .Mac
        case .Virtio:
    ...
    static func fromCore(_ value: VM4ACore.VMModelFieldGraphicDevice.DeviceType) -> Self {
        switch value {
        case .Mac:
            return .Mac
        case .Virtio:
...
extension VMModelFieldStorageDevice.DeviceType {
    func toCore() -> VM4ACore.VMModelFieldStorageDevice.DeviceType {
        switch self {
        case .Block:
            return .Block
        case .USB:
    ...
    static func fromCore(_ value: VM4ACore.VMModelFieldStorageDevice.DeviceType) -> Self {
        switch value {
        case .Block:
            return .Block
        case .USB:
...
extension VMModelFieldNetworkDevice.DeviceType {
    func toCore() -> VM4ACore.VMModelFieldNetworkDevice.DeviceType {
        switch self {
        case .NAT:
            return .NAT
        case .Bridged:
    ...
    static func fromCore(_ value: VM4ACore.VMModelFieldNetworkDevice.DeviceType) -> Self {
        switch value {
        case .NAT:
            return .NAT
        case .Bridged:
...
extension VMModelFieldPointingDevice.DeviceType {
    func toCore() -> VM4ACore.VMModelFieldPointingDevice.DeviceType {
        switch self {
    ...
    static func fromCore(_ value: VM4ACore.VMModelFieldPointingDevice.DeviceType) -> Self {
        switch value {
        case .USBScreenCoordinatePointing:
            return .USBScreenCoordinatePointing
        case .MacTrackpad:
...
extension VMModelFieldAudioDevice.DeviceType {
    func toCore() -> VM4ACore.VMModelFieldAudioDevice.DeviceType {
        switch self {
    ...
    static func fromCore(_ value: VM4ACore.VMModelFieldAudioDevice.DeviceType) -> Self {
        switch value {
        case .InputOutputStream:
            return .InputOutputStream
        case .InputStream:
