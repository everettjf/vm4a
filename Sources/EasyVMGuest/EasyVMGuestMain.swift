...
@main
struct EasyVMGuestMain {
    static let agentVersion = "0.1.0"

    static func main() async {
        let args = CommandLine.arguments
        guard args.count >= 2 else {
            FileHandle.standardError.write(Data("usage: easyvm-guest <path-to-shared-agent-dir>\n".utf8))
            exit(64)
        }
        ...
        do {
            ...
            FileHandle.standardError.write(Data("easyvm-guest: \(error)\n".utf8))
            exit(1)
        }
    }
